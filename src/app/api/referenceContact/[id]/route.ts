...
export async function PUT(req: NextRequest, { params }: ParameterId) {
    try {
        ...
        const response = await prisma.referenceContact.update({
            where: {
                id: fetchedId,
            },
            data: {
...
export async function DELETE(req: NextRequest, { params }: ParameterId) {
    try {
        const fetchedId = parseInt(params.id);
        const response = await prisma.referenceContact.delete({
            where: {
                id: fetchedId,
            },
        });
...
export async function GET(req: NextRequest, { params }: ParameterId) {
    try {
        const fetchedId = parseInt(params.id);
        const contact = await prisma.referenceContact.findUnique({
            where: {
                id: fetchedId,
            },
        });
